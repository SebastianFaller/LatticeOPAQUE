...
% For F_OPRF^late-extract
\newcommand{\Fcor}{f}
\newcommand{\FlateExtract}{\mathcal{F}_{\text{2H-OPRF}}^{\Fcor}}
\newcommand{\Tpreview}{\Table_{\text{preview}}}
\newcommand{\Tprogrammed}{\Table_{\text{programmed}}}
\newcommand{\Correlate}{\textsc{Correlate}}
\newcommand{\Preview}{H_2}
\newcommand{\Tseen}{\advkeys}
\newcommand{\Table}{T}
\newcommand{\Tkey}{\Table_{\mathrm{key}}}
\newcommand{\ProtocolOuter}{\Pi^{\mathrm{outer}}}

% F_FERI
\newcommand{\User}{\mathrm{U}}
\newcommand{\funcFERI}{\func_{\text{FERI}}}
\newcommand{\funcwFERI}{\func_{\text{wFERI}}}
\newcommand{\identity}{\mathrm{id}}
\newcommand{\UserEval}{\mathsf{UsrEval}}
% \newcommand{\ServerEval}{\mathsf{ServerEval}}
\newcommand{\userinput}{\mathsf{userinput}}
\newcommand{\CorruptUserEval}{\mathsf{CorruptUserEval}}
\newcommand{\ServerEval}{\mathsf{ServerEval}}
\newcommand{\serverStarted}{\mathsf{server}}
\newcommand{\HonestComplete}{\mathsf{HonestComplete}}
\newcommand{\MaliciousComplete}{\mathsf{MaliciousComplete}}
